...
const ReservationForm = () => {
  return (
   <div className='bg-green-700 p-6 rounded-lg'>
    ...
    <h1 className='text-center font-bold uppercase text-[30px] md:text-[40px] 
    lg:text-[50px] mt-[0.5rem] text-white'>
     Reservation
    </h1>
    ...
    <div className='mt-[2rem]'>
     ...
     items-center w-[80%] mx-auto justify-between space-x-4'>
      ...
      <input type="date" className='px-10 py-2.5 bg-transparent rounded-lg 
      outline-none font-bold text-[17px] text-white border-[2.2px] border-gray-100'/>

     </div>
     <input type="time" className='px-10 py-2.5 bg-transparent block w-[80%] mx-auto mt-[1rem] 
     rounded-lg outline-none font-bold text-[17px] text-white border-[2.2px] border-r-gray-100' />
     <div className='mt-[2rem] w-[80%] text-center mx-auto'>
      <button className='px-8 py-3 rounded-lg mb-[3rem] text-[16px] w-full 
